package com.example.springbootstatemachine.config;
...
public class StateMachineConfig extends EnumStateMachineConfigurerAdapter<States, Events> {
    ...
    // 其中initial(States.UNPAID)定义了初始状态为UNPAID，states(EnumSet.allOf(States.class))则指定了使用上一步中定义的
    // 所有状态作为该状态机的状态定义。
    @Override
...
//    // 在该实例中会定义具体的状态迁移处理逻辑，上面的实现中只是做了一些输出，实际业务场景会有更复杂的逻辑，所以通常情况下，
